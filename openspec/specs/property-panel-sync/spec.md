...
## Purpose
Bidirectional synchronization between the right-side property panel (React) and the PixiJS canvas. Selecting an item displays its transform properties; editing them updates the Store which redraws the canvas.
