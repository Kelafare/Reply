# canvas-item-interaction

## Purpose
Direct manipulation of CanvasItems on the PixiJS stage — selection, movement, resize, rotation — via pointer events with coordinate system conversion between screen and world space.
